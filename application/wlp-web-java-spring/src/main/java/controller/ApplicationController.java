...
import web.cache.memcached.SetMemcached;
import web.cache.redis.GetRedis;
import web.cache.redis.PublishRedis;
import web.cache.redis.SetRedis;
import web.db.mysql.DeleteMysql;
import web.db.mysql.InsertMysql;
import web.db.mysql.SelectMysql;
import web.mq.rabbitmq.GetRabbitmq;
import web.mq.rabbitmq.PutRabbitmq;
import web.mq.rabbitmq.PutRabbitmqConsumer;
