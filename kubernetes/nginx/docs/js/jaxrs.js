...
$(function() {
  ...
  function subscribeWebSocket(svc) {
    ...
    if (isopen) {
      ...
      ws.onopen = function() {
        ws.onmessage = function(receive) { $(resp).text(receive.data); };
      };
    }
  }
  ...
  $("#getkafka")
      .click(function() { dispMsgFromString(get, kafkaurl + get, respkafka); });
  ...
  $("#putredis")
      .click(function() { dispMsgFromJson(post, redisurl + put, respredis); });

  $("#getredis").click(function() {
    dispMsgFromJsonArray(get, redisurl + get, respredis);
  });

  $("#subscriberedis").click(function() { subscribeWebSocket("redis"); });

  $("#stopredis").click(function() { stopSweSocket("redis"); });
  ...
  $("#subscriberabbitmq").click(function() { subscribeWebSocket("rabbitmq"); });

  $("#stoprabbitmq").click(function() { stopSweSocket("rabbitmq"); });
  ...
  $("#subscribeactivemq").click(function() { subscribeWebSocket("activemq"); });

  $("#stopactivemq").click(function() { stopSweSocket("activemq"); });
  ...
  $("#subscribehazelcast")
      .click(function() { subscribeWebSocket("hazelcast"); });

  $("#stophazelcast").click(function() { stopSweSocket("hazelcast"); });
